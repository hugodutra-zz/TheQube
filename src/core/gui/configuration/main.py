...
class MainConfigDialog (ConfigurationDialog):
 ...
 def SetDefaultValues (self):
  ...
  self.misc.SndUpAPIKey.SetValue(config.main['AudioServices']['sndUpAPIKey'])
 ...
 def SetNewConfigValues (self):
  ...
  config.main['AudioServices']['sndUpAPIKey'] = self.misc.SndUpAPIKey.GetValue()
  logging.info("SndUp API key set to: %s." % config.main['AudioServices']['sndUpAPIKey'])
  #config.main['client']['useGUI'] = self.misc.useGUI.GetValue()
