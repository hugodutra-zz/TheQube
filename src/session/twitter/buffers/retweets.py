...
class Retweets(Dismissable, Tweets):
 ...
 def retrieve_update(self, *args, **kwargs):
  ...
  if count > 100:
   count = 100
  return self.timeline_update(update_function_name=update_function_name, since_id=self.get_max_twitter_id(), respect_count=False, count=count, tweet_mode='extended')
