...
* Favorites and everything related to them renamed to likes as requested by Twitter.

h3. Bugfixes

* "#49: To authorize the second session, TheQube has to be restarted":https://github.com/Oire/theqube/issues/49. Thanks to Manuel Cortéz for this lovely fix!
* "#56: If a user follows, unfollows or blocks someone, TheQube doesn't check for repeating actions":https://github.com/Oire/theqube/issues/56.
* "#48: Line breaks ignored when viewing a tweet":https://github.com/Oire/TheQube/issues/48.
* "#25: Cannot insert a line break if sending tweets on Enter is enabled":https://github.com/Oire/theqube/issues/25.
* Google translation is back again.
* Errors in Brazilian Portuguese translation preventing TheQube from working normally.
